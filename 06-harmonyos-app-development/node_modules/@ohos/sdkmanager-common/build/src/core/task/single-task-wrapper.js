    ...
    constructor(componentTask) {
        ...
        this.execute = (progress) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                throw new sdk_exception_1.SdkException('Maybe another instance is running task, try it later', new error_tip_1.ErrorTip('', `A conflict occurs when downloading the ${this.getComponent().getDisplayName()} ${this.getComponent().getVersion()} SDK`, 'Wait until the SDK is downloaded and try again.'));
            }
            finally {
